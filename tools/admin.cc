...
//  fprintf(stdout, "\n");
  fprintf(stdout,
          "usage: kinetic --id <clusterid> <operation> <target> [--threads <numthreads>] [--space <name>] [-m] [--verbosity debug|notice|warning|error]\n");
  fprintf(stdout, "\n");
  fprintf(stdout,
  ...
  fprintf(stdout,
          "       kinetic ... [--verbosity debug|notice|warning|error]  : (optional) specify verbosity level, warning is set as default \n");
