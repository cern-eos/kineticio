...
int kinetic_help(){
  fprintf(stdout, "usage: kinetic --id <clusterid> <operation> <target> [--threads <numthreads>] [--verbosity debug|notice|warning] [-m]\n");
  fprintf(stdout, "\n");
  ...
  fprintf(stdout, "       kinetic ... [--verbosity debug|notice|warning] ...    : (optional) specify verbosity level \n");
